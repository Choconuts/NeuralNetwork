...
import numpy as np
import os
from vae_net import vae, plot_utils
import glob
...
def main(args):
    ...
    # optimization
    train_op = AutoDecAdam(learn_rate)(loss)
    ...
    if PRR:
        ...
        x_PRR = mnist.test.images[0:PRR.n_tot_imgs]
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(n_epochs):
            ...
            for i in range(1000):
                ...
                batch_xs_input = mnist.train.next_batch(batch_size)[0]
